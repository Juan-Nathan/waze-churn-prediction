...
This project applies advanced data analytics in Python to predict monthly **user churn** in the Waze application using a synthetic dataset designed to simulate real-world application usage and user behavior. Churn measures the number of users who either uninstalled or stopped using the Waze app.
